...
ИД: <input type="text" name="filter" />
...
if ($EvidencijaViewObject->BrojZapisa==0)
	...
	echo "УКУПАН БРОЈ ЗАПИСА:".$EvidencijaViewObject->BrojZapisa;
		...
		echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"3px\">ИД</font><br/>";
		echo "</td>";
		echo "<td style=\"width:15%;\">";
		...
		echo "</td>";
		echo "<td>";
		echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"3px\">ИЗМЕНА</font><br/>";
		echo "</td>";
		echo "<td>";
		echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"3px\">БРИСАЊЕ</font><br/>";
		echo "</td>";
		echo "</tr>";
		...
		echo "</td>";
		echo "<td>";
		echo "<form ACTION=\"EvidecnijaIzmeniForm.php\" METHOD=\"POST\">";
		echo "<input type=\"hidden\" name=\"ID\" value=\"$ID\">";
		echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\"><input TYPE=\"submit\" name=\"izmeniEvidenciju\" value=\"IZMENI\" /></font></b>";
		echo "</form>";
		echo "</td>";
		echo "<td>";
